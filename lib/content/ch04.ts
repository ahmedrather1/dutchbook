  ...
  lessons: [
    ...
    },
    {
      ...
      points: [
        ...
        "Polymarket supports **merge** and **negative risk**. Kalshi, as modelled here, does not.",
      ...
      body: [
        ...
        "Polymarket also lets you merge a YES and a NO back into $1.00 whenever you like, and has a mechanic called negative risk for multi-outcome events. Chapter 6 uses merge, and Chapter 8 uses negative risk. Kalshi, as modelled here, has neither.",
      ],
    },
  ],
